                      ...
                      <span class="card-icon">
                        <i class="flaticon2-file text-warning"></i>
                            ...
                            <div class="card-toolbar">
                                ...
                                <!--begin::Button-->
                                  <a href="{{ route('docvehiculo.listadodocvehiculo') }}" class="btn btn-warning font-weight-bold"><i class="flaticon2-back"></i> Regresar</a>
                                <!--end::Button-->
                                  ...
                                  @foreach($data as $unid)
                                    <tr>
                                      ...
                                      <td class="text-center">
                                        <button class="btn btn-clean btn-icon btn-outline-warning mt-1 activar-documento" data-id="{{ $unid->id }}" data-nombre="{{ $unid->tipo_documento_vehiculo }}" data-toggle="tooltip" data-theme="dark" title="Activar Documento" ><i class="flaticon2-reply "></i></button>
                                      </td>
                                    </tr>
                                  @endforeach
                                </tbody>
