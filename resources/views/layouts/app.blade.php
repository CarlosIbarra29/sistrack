...
<div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
    ...
    <a href="{{ route('tablero.show') }}">
        <img alt="Logo" class="h-50px brand-logo" src="{{ asset('theme/assets/media/logos/nuevo.png') }}" />
    </a>
    <!--end::Logo-->
    <!--begin::Toolbar-->
                                ...
                                <div class="menu-submenu">
                                    ...
                                    <ul class="menu-subnav">
                                        ...
                                        <li id="menuTarifario" class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                            <a href="{{ route('tarifario.listadotarifario') }}" class="menu-link menu-toggle">
                                ...
                                <div class="menu-submenu">
                                    ...
                                    <ul class="menu-subnav">
                                        ...
                                        <li id="menuRegistroCustodios" class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                            <a href="{{ route('custodio.listadocustodio') }}" class="menu-link menu-toggle">
                                                <i class="flaticon-users-1 menu-icon"></i>
                                                <span class="menu-text">Lista Custodios</span>
                                                <!--<i class="menu-arrow"></i>-->
                                            </a>
                                            <!--<div class="menu-submenu">-->
                                            <!--    <i class="menu-arrow"></i>-->
                        ...
                        <li id="menuCatalogos" class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                            ...
                            {{-- END  MENU  CLIENTES --}}
                                    ...
                                    <li id="menuCatalogoDocumentacionCustodio"  class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                        <a href="{{ route('doccustodio.listadodoccustodio') }}" class="menu-link menu-toggle">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                    ...
                                    <li id="menuCatalogoDocumentacionVehiculo"  class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                        <a href="{{ route('docvehiculo.listadodocvehiculo') }}" class="menu-link menu-toggle">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                    ...
                                    <li id="menuCatalogoDocumentacionArma"  class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                        <a href="{{ route('docarma.listadodocarma') }}" class="menu-link menu-toggle">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                    ...
                                    <li id="menuCatalogoDocumentacionCliente"  class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                        <a href="{{ route('doccliente.catalogoDocumentos') }}" class="menu-link menu-toggle">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span class="menu-text">Documentación Cliente</span>
                                            <!--<i class="menu-arrow"></i>-->
                                        </a>
                                        <!--<div class="menu-submenu">-->
                                        <!--    <i class="menu-arrow"></i>-->
