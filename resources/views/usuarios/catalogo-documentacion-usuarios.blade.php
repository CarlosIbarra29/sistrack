...
@section('title')
    Inventario de documentación del usuario
@endsection

@push('scripts')
  <script src="{{ asset('js/catalogos/custodios/catalogoDocumentacionUsuario.js') }}"></script> 
        ...
        <div class="col-xl-12">
          ...
          <div class="card card-custom">
            <div class="card-header">
              ...
              <div class="card-toolbar">
                ...
                <a href="{{ route('doccustodio.catalogodocinactivos') }}" class="btn btn-light-primary font-weight-bolder mr-3 ml-3">
                  <i class="far fa-trash-alt"></i>Documentación Inactivos
                </a>
            ...
            <div class="card-body">
              ...
              <input type="hidden" id="documentocustdatatable" value="{{ route('documentacion.documentacionUsuarioDatatable') }}">
...
{{-- MODALS --}}
@include('catalogos.custodios.modals.modal_nuevo_documento')
@include('catalogos.custodios.modals.modal_editar_documento')
