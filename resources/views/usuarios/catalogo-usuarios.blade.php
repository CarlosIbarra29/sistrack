...
@section('title')
    Catálogo de documentación Usuario
@endsection

@push('scripts')
  <script src="{{ asset('js/catalogos/custodios/CatalogoDocumentosUsuario.js') }}"></script> 
                    ...
                    <div class="card card-custom">
                        <div class="card-header">
                            <div class="card-title">
                              ...
                              <h3 class="card-label">Inventario de documentación del Usuario</h3>
                            </div>
                            <div class="card-toolbar">
                                ...
                                <a href="{{ route('usuario.catalogodocumentosinactivos') }}" class="btn btn-light-primary font-weight-bolder mr-3 ml-3">
...
{{--                                             <li class="navi-item">
                        ...
                        <!--begin: Datatable-->
                          ...
                          <input type="hidden" id="documentocustdatatable" value="{{ route('usuario.documentosdatatable') }}">
...
{{-- M O D A L S --}}
      ...
      <div class="modal-dialog">
          <div class="modal-content">
              ...
              <div class="modal-body">
                <form action="{{ route('usuario.guardardocumento') }}" method="post" id="submit_documento">
                @csrf
  ...
  <div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" id="model_edit_tipodocumento">
      <div class="modal-dialog">
          <div class="modal-content">
              ...
              <div class="modal-body">
                <form action="{{ route('usuario.editardocumento') }}" method="post" id="submit_documentoedit_edit">
                @csrf
                      <div class="row form-group">
                        <div class="col-lg-12 mt-2">
                          <label>Nombre del documento</label>
  ...
  <form method="post" id="tipodocumento_delete_form" action="{{ route('usuario.desactivardocumento') }}" enctype="multipart/form-data">
    @csrf
