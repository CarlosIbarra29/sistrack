                    ...
                    <div class="card card-custom">
                      ...
                      <span class="card-icon">
                        <i class="flaticon2-file text-warning"></i>
                            ...
                            <div class="card-toolbar">
                                  <a href="{{ route('programacion.nuevaprogramacion') }}"class="btn btn-light-warning font-weight-bold mr-3 ml-3" style="color:black"><i class="la la-plus"></i>Nuevo</a>
                                    <a href="{{ route('programacion.programacioninactivas') }}" class="btn btn-light-warning font-weight-bold mr-3 ml-3" style="color:black"><i class="far fa-trash-alt"></i>Clientes inactivos</a>

                                <div class="dropdown dropdown-inline mr-2">
                                    <button type="button" class="btn btn-light-warning font-weight-bold mr-3 ml-3" style="color:black"   data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                      <span class="svg-icon svg-icon-md">
                                      <!--begin::Svg Icon | path:assets/media/svg/icons/Design/PenAndRuller.svg-->
                                      <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
