                                ...
                                <tbody>
                                  @foreach($data as $unid)
                                    <tr>
                                      ...
                                      <td>{{ $unid->telefono }}</td>
                                      <td>{{ $unid->mail }}</td>
                                      <td><span class="label font-weight-bold  label-outline label-inline" style="font-size: 16px;  color: orange; border: 1px solid orange !important">2</span></td>
