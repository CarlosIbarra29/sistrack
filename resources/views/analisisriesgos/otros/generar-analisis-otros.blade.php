    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card card-custom gutter-b">
                ...
                <input type='hidden' id='url_alcances' value='{{ route('analisis.obteneralcancesotros') }}'>
                <!--begin::Form-->
                    <div class="card-body">
                            ...
                            <div class="card-body">
                                <div class="row form-group">
                                    <div class="col-lg-8">
                                        ...
                                        <select class="form-control" id="punto_normativo_otros" name="punto_normativo"  required >
                                    ...
                                    <div class="col-lg-4 mt-2 text-center">
                                        ...
                                        @else
                                            ...
                                            @if($num == 1)
                                                <button  class="btn btn-clean btn-icon btn-outline-success mt-1 disabled" id="alcance_menos_otros" data-toggle="tooltip" data-theme="dark" title="" >
                                                    <i class="la la-arrow-left"></i>
                                                </button>
                                            @else
                                                <button  class="btn btn-clean btn-icon btn-outline-success mt-1" id="alcance_menos_otros" data-toggle="tooltip" data-theme="dark" title="" >
                                                    <i class="la la-arrow-circle-left"></i>
                                                </button>
                                            @endif

                                            @if($num == 9)
                                                <button  class="btn btn-clean btn-icon btn-outline-success mt-1 disabled" id="alcance_mas_otros" data-toggle="tooltip" data-theme="dark" title="" >
                                                    <i class="la la-arrow-right"></i>
                                                </button>
                                            @else
                                                <button  class="btn btn-clean btn-icon btn-outline-success mt-1" id="alcance_mas_otros" data-toggle="tooltip" data-theme="dark" title="" >
                ...
                {{-- ENvoiar Formulario  --}}
                <form action="{{ route('analisis.guardarriesgootros') }}" method="post" id="submit_analisis_social">  
                                @csrf
