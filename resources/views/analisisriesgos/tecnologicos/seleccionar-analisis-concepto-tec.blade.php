                        ...
                        <div class="card card-custom">
                            <div class="card-header">
                                ...
                                <div class="card-toolbar">
                                  ...
                                  <a href="{{ route('analisis.analisistecnologicoscli', $id_cliente) }}" class="btn btn-light-primary font-weight-bolder mr-3 ml-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="text-center div_riesgos_sociales">
                                            <a href="{{ route('analisis.generaranalisistecno', [$id_cliente, $ConceptosTecnologicos[0]->id, 0, 1]) }}" class="btn btn-light-warning font-weight-bolder mr-3 ml-3">
                                            Crear riesgo tecnológico</a>
                                        </div>

                                        <img src="{{ asset('img/riesgo_tec.png') }}" class="img-responsive">
                                    </div>
