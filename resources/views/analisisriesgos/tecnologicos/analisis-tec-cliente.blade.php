...
@endpush
@section('title')
  Analisis de riesgos tecnológicos
@endsection
@section('content')
                    ...
                    <div class="card card-custom">
                      ...
                      <span class="card-icon">
                        <i class="flaticon2-file text-primary"></i>
                                ...
                                <h3 class="card-label">Analisis de riesgos tecnológicos ({{ $cliente->organizacion }})</h3>
                            </div>
                            <div class="card-toolbar">
                              ...
                              <a href="{{ route('analisis.graficastecnologicas', $cliente->id) }}" class="btn btn-light-primary font-weight-bolder mr-3 ml-3">
                                <i class="la la-bar-chart"></i>Graficas
                              </a>

                              <a href="{{ route('analisis.seleccionaanalisistec', $cliente->id) }}" class="btn btn-light-primary font-weight-bolder mr-3 ml-3">
                            ...
                            <table class="table table-hover table-checkable" id="kdatatable_clientes_inactivos">
                                ...
                                <tbody>
                                  @foreach($data as $unid)
                                    <tr>
                                      <td>{{ $unid->id }}</td>
                                      <td>{{ $unid->librorConceptosTecnologico->alcance }}</td>
