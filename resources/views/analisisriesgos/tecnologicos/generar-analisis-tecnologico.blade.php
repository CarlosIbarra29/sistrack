    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card card-custom gutter-b">
                ...
                <input type='hidden' id='url_alcances' value='{{ route('analisis.obteneralcancestecnologicos') }}'>
                <!--begin::Form-->
                    <div class="card-body">
                ...
                {{-- ENvoiar Formulario  --}}
                <form action="{{ route('analisis.guardarriesgotecnologico') }}" method="post" id="submit_analisis_social">  
                                @csrf
