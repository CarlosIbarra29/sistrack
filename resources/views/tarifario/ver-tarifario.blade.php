                    ...
                    <div class="col-lg-8">
                        <div class="card card-custom mb-5 border shadow-sm">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-4">
                                        <label class="font-weight-semibold">Clientes con arma</label>
                                        <p class="form-control form-control-solid">
                                            {{ $tarifario->clientes_con_arma ?: '0' }}
                                        </p>
                                    </div>
                                    <div class="col-lg-4">
                                        <label class="font-weight-semibold">Clientes sin arma</label>
                                        <p class="form-control form-control-solid">
                                            {{ $tarifario->clientes_sin_arma ?: '0' }}
                                        </p>
                                    </div>
                                    <div class="col-lg-4">
                                        <label class="font-weight-semibold">Personal armado</label>
                                        <p class="form-control form-control-solid">
                                            {{ $tarifario->personal_armado ?: '0' }}
                                        </p>
                                    </div>
                                </div>
