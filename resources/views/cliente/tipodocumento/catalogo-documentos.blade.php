...
{{--                                             <li class="navi-item">
                        ...
                        <!--begin: Datatable-->
                          ...
                          <input type="hidden" id="documentosdatatable" value="{{ route('doccliente.municipiosdatatable') }}">
...
{{-- M O D A L S --}}
    ...
    <div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" id="kt_modal_1">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('doccliente.guardartipodocumento') }}" method="post" id="submit_documento">
                @csrf
                    <div class="modal-body">
                        <div class="row form-group">
                            <div class="col-lg-12 mt-2">
                                <label>Nombre del tipo de documento</label>
                                <input type="text" class="form-control" name="tipo" id="documento" onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()"/>
                            </div>
                        </div>
                    </div>
                </form>
    ...
    <div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" id="model_tipo_documento">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                  <form action="{{ route('doccliente.editartipoDocumento') }}" method="post" id="submit_documento_edit">
                  @csrf
                        <div class="row form-group">
                            <div class="col-lg-12 mt-2">
                                <label>Nombre del tipo de documento</label>
                              <input type="text" class="form-control" name="tipo" id="documento_edit" onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()"/>
                            </div>
                        </div>

                    <input type="hidden" name="id_documento" id="id_documento_edit" value="">
                  </form> 
                </div>
  ...
  <form method="post" id="documento_delete_form" action="{{ route('doccliente.eliminartipoDocumento') }}" enctype="multipart/form-data">
    @csrf
    <input type="hidden" name="id" id="id_delete_documento" value="">
  </form>
