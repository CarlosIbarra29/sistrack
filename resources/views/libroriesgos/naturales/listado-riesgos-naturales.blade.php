...
@section('title')
    Listado libro de riesgos naturales
@endsection
                        ...
                        <div class="card card-custom">
                            <div class="card-header">
                                <div class="card-title">
                                    ...
                                    <h3 class="card-label">Listado de riesgos naturales</h3>
                                </div>
                                          ...
                                          @foreach($alcances as $unid)
                                            <tr>
                                              ...
                                              <td class="text-center">
                                                <a  href="{{ route('libronat.riesgonaturalid', $unid->id) }}" class="btn btn-sm btn-clean btn-hover-icon-success btn-icon activar-emisor" data-id="{{ $unid->id }}" data-nombre="{{ $unid->alcance }}" data-toggle="tooltip" data-theme="dark" title="Ver '{{ $unid->alcance }}'" ><i class="flaticon-eye"></i></a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('libronat.adnameriesgonat') }}" method="post" id="submit_nameriesgo">
                        @csrf
    ...
    <div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('libronat.editnameriesgonat') }}" method="post" id="submit_nameriesgo_edit">
                        @csrf
                        <div class="row form-group">
                            <div class="col-lg-12 mt-2">
                                <label>Nombre del alcance</label>
