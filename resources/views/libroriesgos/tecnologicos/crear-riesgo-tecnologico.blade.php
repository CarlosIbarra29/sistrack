        ...
        <div class="col-lg-12">
            ...
            <div class="card card-custom gutter-b">
                <div class="card-header">
                    <h3 class="card-title">Agregar riesgo tecnologico</h3>
                </div>
                <!--begin::Form-->
                <form action="{{ route('librotec.guardarriesgotecnologico') }}" method="post" id="submit_social">
                    @csrf
                    <div class="card-body">
                    ...
                    <div class="card-footer">
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <a href="{{ route('librotec.riesgotecnologicoid',$id_alcance ) }}"  class="btn btn-secondary">Cancelar</a>
                            </div>
                        </div>
                    </div>
                </form>
