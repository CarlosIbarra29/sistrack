...
@section('title')
    Listado libro de riesgos sociales
@endsection
                        ...
                        <div class="card card-custom">
                            <div class="card-header">
                                <div class="card-title">
                                    ...
                                    <h3 class="card-label">Listado de riesgos sociales</h3>
                                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('libro.adnameriesgo') }}" method="post" id="submit_nameriesgo">
                        @csrf
    ...
    <div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('libro.editnameriesgo') }}" method="post" id="submit_nameriesgo_edit">
                        @csrf
                        <div class="row form-group">
                            <div class="col-lg-12 mt-2">
                                <label>Nombre del alcance</label>
