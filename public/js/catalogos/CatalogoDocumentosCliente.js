            ...
            columnDefs: [
                {
                    ...
                    render: function(data, type, full, meta) {
                            ...
                            return '\
                                <button class="btn btn-sm btn-clean btn-hover-icon-success btn-icon" onClick="editardocumento(\'' + full.nombre + '\', '+full.id+')" data-toggle="modal" data-target="#model_tipo_documento" data-toggle="tooltip" data-theme="dark" title="Editar Tipo de Documento">\
                                    <i class="flaticon-edit"></i></button>\
                                <button class="btn btn-sm btn-clean btn-hover-icon-success btn-icon" onClick="deletedocumento(\'' + full.nombre + '\', '+full.id+')" data-toggle="tooltip" data-theme="dark" title="Desactivar Tipo de Documento">\
...
function editardocumento(nombre, id) {
    document.getElementById("id_documento_edit").value = id;
    document.getElementById("documento_edit").value = nombre;
}

$("#edit_documento_submit").click(function(){
    var documento_edit = document.getElementById("documento_edit").value;
    if(documento_edit == ""){
        Swal.fire("Para continuar debes agregar el nombre del tipo de documento");
    }else{
        Swal.fire({
        ...
        document.getElementById("submit_documento_edit").submit();
    }
});
