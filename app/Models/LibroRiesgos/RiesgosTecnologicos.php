 ...
 * @property User $user
 */
class RiesgosTecnologicos extends Model
{
    /**
     ...
     * @var string
     */
    protected $table = 'libror_tecnologicos_alcances';
    ...
    public function ConceptosTecnologicos()
    {
        return $this->belongsTo('App\Models\LibroRiesgos\ConceptosTecnologicos', 'social_alcance_id');
    }
