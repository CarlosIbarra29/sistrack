...
class Custodio extends Model
{
    ...
    {
        return $this->belongsTo('App\Models\User', 'users_responsable');
    }

    public function userCustodio()
    {
        return $this->belongsTo('App\Models\User', 'users_custodios');
    }
}
