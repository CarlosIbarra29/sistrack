 ...
 * @property User $user
 */
class AnalisisRiesgoSocialImpacto extends Model
{
    /**
     * @var array
     */
    protected $fillable = ['analisis_riesgo_social_id', 'created_at', 'updated_at', 'iduserCreated', 'iduserUpdated', 'id_impacto'];
