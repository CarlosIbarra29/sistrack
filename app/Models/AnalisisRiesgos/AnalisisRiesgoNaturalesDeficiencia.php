 ...
 * @property User $user
 */
class AnalisisRiesgoNaturalesDeficiencia extends Model
{
    /**
     * @var array
     */
    protected $fillable = ['analisis_riesgo_naturales_id', 'id_deficiencia', 'created_at', 'updated_at', 'iduserCreated', 'iduserUpdated'];
